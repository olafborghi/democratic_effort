% NOTE (MvM 2025): Works with Democratic Effort Task without changes. 
% This function simply extracts fit metrics from rootfile.em.(model).fit, 
% independent of the number of agents or parameters.

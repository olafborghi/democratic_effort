...
% NOTE (MvM 2025): No changes required for the Democratic Effort Task, since this 
% function operates only on parameter estimates (m, h) and does not depend 
% on task design (e.g., agent or effort levels).

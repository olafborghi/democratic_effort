% NOTE (MvM 2025): No changes needed for Democratic Effort Task.
% This function only standardises figure appearance after plotting
% (tick direction, box style, clipping).
